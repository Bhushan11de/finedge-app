      ...
      <div className="row p-5 mt-5 text-center">
        <div className="col-4 p-4">
          <img 
            ...
            alt="Free equity delivery" // Descriptive alt text for the first image
          />
        ...
        <div className="col-4 p-4">
          <img 
            ...
            alt="Intraday and F&O trades" // Descriptive alt text for the second image
          />
        ...
        <div className="col-4 p-4">
          <img 
            src="media/images/pricingEquity.svg" 
            alt="Free equity delivery for mutual funds" // Descriptive alt text for the third image
          />
          <h1 className="fs-3">Free equity delivery</h1>
